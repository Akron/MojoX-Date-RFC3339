...
=item I<Level 0>: Complete date plus hours, minutes and seconds

=item I<Level 1>: Complete date plus hours and minutes

=item I<Level 2>: Complete date

=item I<Level 3>: Year and month
...
L<MojoX::Date::RCF3339> implements the following methods.
